...
for (let i = 0; i < btnPlusorMinus.length; i++) {
    console.log(btnPlusorMinus.length);
    btnPlusorMinus[i].addEventListener('click', function () {
        PlusorMinus(this)
    })
}
// getAttribute. aydi olish uchun ishlatiladi. id
// let parentID = element.closest. eng yaqin elementtan ol degani
